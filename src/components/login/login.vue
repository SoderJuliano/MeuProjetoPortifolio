            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div v-if="!showConfirmPassword && inOnboarding" class="pass-container">
                        <input type="password" class="form-control" :placeholder="this.language === 'pt-br' ? 'Confirme sua senha' : 'Confirm your password'" v-model="repeatPassword" @input="validatePassword">
                    ...
                    <div v-if="showConfirmPassword && inOnboarding" class="pass-container">
                        ...
                        <input type="text" class="form-control" :placeholder="this.language === 'pt-br' ? 'Senha' : 'Password'" v-model="repeatPassword" @input="validatePassword">
